...
export default function QuestionIndicators(props: QuestionIndicatorsProps) {
  const { numQuestions, currentQuestion, setCurrentQuestion, completedQuestions } = props;
